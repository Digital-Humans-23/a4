...
if __name__=='__main__':
    ...
    if args.split == 'all':
        ...
        subjects_list = subjects_train+subjects_test
    elif args.split == 'train':
        subjects_list = subjects_train
    elif args.split == 'test':
        subjects_list = subjects_test
    else:
    ...
    for ss in subjects_list:
        ...
        for seq in tqdm(seqs):
            ...
            while t < n_frames:
                ...
                cmu_path_out_ss = os.path.join(cmu_path_out, ss)
                if not os.path.exists(cmu_path_out_ss):
                    os.makedirs(cmu_path_out_ss)
                outfilename = os.path.join(cmu_path_out_ss, 'subseq_{:07d}.npz'.format(index_subseq))
